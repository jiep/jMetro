...
public class Demo2 {
		...
		Maths.inicializarMatriz(g.getCostes());
	 	...
	 	do{
			...
			llegada = s.nextInt();
		 	...
		 	LinkedList<Integer> l = AlgoritmosGrafos.rPath(salida, llegada, path);
	
		 	System.out.println("La ruta desde " + est[salida].getNombre() + " hasta " + est[llegada].getNombre() + " es: ");
		 	System.out.println();
		 	...
		 	System.out.println("La distancia es: " + shortpath[salida][llegada] + " metros");
		 	System.out.println();
	...
	private static void cargarEstaciones(Estacion[] estaciones){
		...
		estaciones[190]= new Estacion( "Parque Oestacionese");
	...
	private static void Menu(){
		...
		System.out.println("  Advertencia: Sólo contiene datos de la línea 1  ");
		System.out.println("Sólo las siguientes estaciones están disponibles: ");
		System.out.println();
		System.out.println("260 Valdecarros");
		System.out.println("146 Las Suertes");
		System.out.println("134 La Gavia"); 
		System.out.println(" 78 Congosto");
		System.out.println("268 Villa de Vallecas");
		System.out.println("243 Sierra de Guadalupe");
		System.out.println("166 Miguel Hernandez");
		System.out.println(" 13 Alto del Arenal");
		System.out.println(" 49 Buenos Aires");
		System.out.println("201 Portazgo");
		System.out.println("173 Nueva Numancia");
		System.out.println("211 Puente de Vallecas");
		System.out.println("181 Pacifico");
		System.out.println("164 Menendez Pelayo");
		System.out.println(" 28 Atocha Renfe");
		System.out.println(" 27 Atocha");
		System.out.println(" 17 Anton Martin");
		System.out.println("251 Tirso de Molina");
		System.out.println("246 Sol");
		System.out.println("110 Gran Via");
		System.out.println("254 Tribunal");
		System.out.println(" 46 Bilbao");
		System.out.println("123 Iglesia");
		System.out.println("223 Rios Rosas");
		System.out.println(" 82 Cuatro Caminos");
		System.out.println(" 15 Alvarado");
		System.out.println(" 99 Estrecho");
		System.out.println("250 Tetuan");
		System.out.println("258 Valdeacederas");
		System.out.println("198 Plaza de Castilla");
		System.out.println(" 64 Chamartin");
		System.out.println(" 35 Bambu");
		System.out.println("193 Pinar de Chamartin");
		
		System.out.println("Introduzca una estación de origen y otra de destino: ");
